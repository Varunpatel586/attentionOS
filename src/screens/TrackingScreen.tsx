...
import AttentionOSBridge, { PermissionStatus } from '../utils/AttentionOSBridge';
...
const TrackingScreen = () => {
    ...
    const handleStartTracking = () => {
        ...
        setIsTracking(true);
        Alert.alert('Tracking Started', 'AttentionOS is now monitoring your app usage.');
    };
    ...
    const allPermissionsGranted = permissions.usageStats && permissions.accessibility;
                ...
                <View style={styles.section}>
                    ...
                    >
                        <View style={styles.permissionLeft}>
                            <Ionicons
                                name={permissions.usageStats ? 'checkmark-circle' : 'alert-circle-outline'}
                                size={24}
                    ...
                    >
                        <View style={styles.permissionLeft}>
                            <Ionicons
                                name={permissions.accessibility ? 'checkmark-circle' : 'alert-circle-outline'}
                                size={24}
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.infoCard}>
                        <Text style={styles.infoText}>
                            AttentionOS tracks your attention capture in distraction apps like Instagram, YouTube, and TikTok.
                        </Text>
                        <Text style={styles.infoText}>
